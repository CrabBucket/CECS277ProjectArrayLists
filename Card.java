 ...
 * A playing card that stores a cards value suit and if it's visible.
 * Has Associated getter and setter methods and toString.
...
public class Card {
	 ...
	 * If this card is greater than the other card c, returns 1.
	 * If this card is less than the other card c, returns -1.
	...
	public int compareTo(Card c) {
		int result;
		if(faceValue()>this.faceValue()) {
			result = 1;
		}else if(faceValue()<this.faceValue()) {
			result = -1;
		}else {
			result = 0;
		}
